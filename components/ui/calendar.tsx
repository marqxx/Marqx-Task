...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "relative flex aspect-square size-auto w-full min-w-(--cell-size) items-center justify-center rounded-lg p-0 font-normal transition-all duration-200 select-none outline-none border border-transparent !shadow-none",
        // Default Hover
        "hover:bg-secondary dark:hover:bg-muted hover:text-foreground",
        // Today styling - Solid Primary (Main)
        ...
        // Selected styling - Dotted/Dashed border (Click)
